...
export default function FilterBar({ terminoBusqueda, setTerminoBusqueda, filtroFechaOrdenes, setFiltroFechaOrdenes, placeholder = "Buscar por ID de pedido, cliente o DNI..." }) {
  return (
